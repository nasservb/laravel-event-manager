            ...
            <table align="center" style="font-size:13px;line-height:22px;color:#333333;border-spacing:0;font-family:tahoma,sans-serif;border-radius:7px;max-width:700px;Margin:0 auto;width:100%;background-color:#ffffff;direction:rtl">
                                        ...
                                        <table style="line-height:22px;Margin:0;color:#333333;border-spacing:0;font-family:tahoma,sans-serif;font-size:13px;text-align:right">
                                            <tbody><tr>
                                                <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;font-family:tahoma,sans-serif;text-align:right">
                                                    <p dir="rtl" style="font-size:13px;line-height:22px;color:#333333;Margin:1em 0">کاربرگرامی، <strong>{{$user->name . ' ' . $user->family }}</strong><br>
                                                        اطلاعات پنل  شما به شرح زیر است:
                                                    </p>
                                                </td>
                                            </tr>
                                            ...
                                            <tbody><tr>
                                                <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;font-family:tahoma,sans-serif;text-align:right">
                                                    <p dir="rtl" style="font-size:13px;line-height:22px;color:#333333;Margin:1em 0">
                                                        شماره: <span dir="ltr">{{$user->id}}</span>
                                                        <br>
                                                        تاریخ فعال سازی: <span dir="ltr">{{jdate($user->created_at)->format('Y-m-d')}}</span>
                                                    </p>
                                                </td>
                                            </tr>
                                            </tbody></table>
                ...
                <tr>
                    <td style="font-family:tahoma,sans-serif;text-align:right;padding-top:0;padding-bottom:20px;padding-right:20px;padding-left:20px">
                        <table width="100%" style="font-size:13px;line-height:22px;Margin:0;color:#333333;border-spacing:0;font-family:tahoma,sans-serif">
                            <tbody><tr>
                                <th colspan="2" style="font-size:13px;text-align:center;padding-top:10px;padding-bottom:10px;padding-right:5px;padding-left:5px;border-left-width:1px;border-left-style:solid;border-left-color:#ffffff;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#ffffff;background-color:#3db7fa;font-weight:normal;color:#ffffff">اطلاعات کاربری</th>

                            </tr>
                            <tr>
                                <td style="font-family:tahoma,sans-serif;font-size:13px;text-align:center;padding-top:10px;padding-bottom:10px;padding-right:5px;padding-left:5px;border-left-width:1px;border-left-style:solid;border-left-color:#ffffff;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#ffffff;background-color:#eeeeee;background-image:none;background-repeat:repeat;background-position:top left">نام کاربری</td>
                                <td style="font-family:tahoma,sans-serif;font-size:13px;text-align:center;padding-top:10px;padding-bottom:10px;padding-right:5px;padding-left:5px;border-left-width:1px;border-left-style:solid;border-left-color:#ffffff;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#ffffff;background-color:#eeeeee;background-image:none;background-repeat:repeat;background-position:top left">{{$user->email}}</td>

                            </tr>
                            <tr>
                                <td style="font-family:tahoma,sans-serif;font-size:13px;text-align:center;padding-top:10px;padding-bottom:10px;padding-right:5px;padding-left:5px;border-left-width:1px;border-left-style:solid;border-left-color:#ffffff;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#ffffff;background-color:#eeeeee;background-image:none;background-repeat:repeat;background-position:top left">رمز عبور</td>
                                <td style="font-family:tahoma,sans-serif;font-size:13px;text-align:center;padding-top:10px;padding-bottom:10px;padding-right:5px;padding-left:5px;border-left-width:1px;border-left-style:solid;border-left-color:#ffffff;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#ffffff;background-color:#eeeeee;background-image:none;background-repeat:repeat;background-position:top left">{{$pass }}</td>

                            </tr>
                            <tr>
                                <td style="font-family:tahoma,sans-serif;font-size:13px;text-align:center;padding-top:10px;padding-bottom:10px;padding-right:5px;padding-left:5px;border-left-width:1px;border-left-style:solid;border-left-color:#ffffff;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#ffffff;background-color:#eeeeee;background-image:none;background-repeat:repeat;background-position:top left">آدرس ورود به پنل</td>
                                <td style="font-family:tahoma,sans-serif;font-size:13px;text-align:center;padding-top:10px;padding-bottom:10px;padding-right:5px;padding-left:5px;border-left-width:1px;border-left-style:solid;border-left-color:#ffffff;border-bottom-width:1px;border-bottom-style:solid;border-bottom-color:#ffffff;background-color:#eeeeee;background-image:none;background-repeat:repeat;background-position:top left">
                                    <a target="_blank" href="{{route('login')}}">{{route('login')}}</a> </td>
